...
if __name__ == '__main__':from flask import Flask, request, render_template_string, send_file, redirect, jsonify
import json
import os
import re
import pdfplumber
...
if __name__ == '__main__':
    ...
    # So we don't need to create them again here
    os.makedirs(app.config['UPLOAD_FOLDER'], exist_ok=True)
    app.run(debug=True)from flask import Flask, request, render_template_string, send_file, redirect, jsonify
import json
import os
import re
import pdfplumber
